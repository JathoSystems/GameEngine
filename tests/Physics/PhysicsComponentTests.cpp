...
TEST_CASE("PhysicsComponent", "[PhysicsComponent]") {
    ...
    SECTION("Component initializes with null body ID") {
        Box2DFacade facade;
    ...
    SECTION("Component with BoxCollider initializes body") {
        Box2DFacade facade;
        facade.init(0.0f, 981.0f);
        
        PhysicsComponent physics(&facade);
        physics.setBodyType(BodyType::DYNAMIC);
        physics.setCollider(std::make_unique<BoxCollider>(100.0f, 50.0f));
