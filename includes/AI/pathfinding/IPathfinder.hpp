...
public:
    ...
    virtual std::vector<std::unique_ptr<Position>> getPath(Scene* scene, const Position& start, const Position& end, int interval = 5, std::string heuristicType = "manhatten") = 0;
};
